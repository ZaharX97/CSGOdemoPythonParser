...
def analyze_demo(path):
    ...
    parser.subscribe_to_event("gevent_round_freeze_end", ff.round_fr_end)
    parser.subscribe_to_event("gevent_bomb_planted", ff.bomb_planted)
    parser.subscribe_to_event("gevent_hostage_follows", ff.hostage_follows)
